...
public class CreateHelixTests
{
    ...
    public void SingleHelixTest()
    {
        ...
        Helix helix = grid.AddHelix(0, grid.Grid2D[0, 0]);
        helix.Extend(64);
        ...
        Assert.AreEqual(grid.Grid2D[0, 0], helix.GridCircleData);
    }

    [Test]
    public void HelixCommandTest()
    {
        //DNAGrid grid = DrawGrid.CreateGrid("1", "XY", new Vector3(0, 0, 0), "square"); Commenting out for grid circle refactor - Ollie 4/10/2025
        ...
        //Assert.AreEqual(grid.Grid2D[0, 0], helix2.GridCircleData);
