...
public class ReflectGrid : MonoBehaviour
{
    ...
    {
        //List<DNAGrid> grids = SelectGrid.Grids; Commenting out for grid circle refactor - Ollie 4/10/2025
        //if (grids.Count == 0)
        //{
    ...
    {
        //int maxXIndex = grid.GridXToIndex(grid.MaximumBound.X); Commenting out for grid circle refactor - Ollie 4/10/2025
        //int maxYIndex = grid.GridYToIndex(grid.MaximumBound.Y);
